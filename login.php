...
?>
  ...
  <form method="post">
    <div class="form-group">
      ...
      <input type="email" name="email" id="email" required class="form-control <?php echo htmlspecialchars($errors?'is-invalid':''); ?>" value=""/>
      <?php
    ...
    <div class="form-group">
      ...
      <input type="password" name="password" id="password" required class="form-control <?php echo htmlspecialchars($errors?'is-invalid':''); ?>" />
    </div>
